...
/**
 * A widget to input an image, upload it to IPFS, and get URL.
 */
export default function ImageInput(props: WidgetProps) {
  ...
  const { uploadFileToIPFS, ipfsUrlToHttpUrl } = useIpfs();
    ...
    <Box sx={{ ...(propsSx as object) }}>
      ...
      <label htmlFor="input" style={{ width: size, height: size }}>
        <Avatar
          ...
          src={!isLoading ? ipfsUrlToHttpUrl(propsImage) : undefined}
        >
